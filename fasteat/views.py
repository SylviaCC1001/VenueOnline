...
def guestCart(request):
    ...
    # print('GuestCart with resId',cart[resId])
    items = []
    ...
    for i in cart[resId]:
        try:
            itemQuantity += cart[resId][i]['quantity']
            item = FoodItem.objects.get(id=i)
            totalPrice = cart[resId][i]['quantity'] * item.price
            order['getTotalPrice'] += totalPrice
            order['getTotalQuantity'] = cart[resId][i]['quantity']
            item = {
                'foodItem':{
                    'id':item.id,
                    'name':item.name,
                ...
                'quantity':cart[resId][i]['quantity'],
